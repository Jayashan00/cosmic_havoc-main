// lib/overlays/title_overlay.dart
...
class _TitleOverlayState extends State<TitleOverlay> {
  ...
  void initState() {
    super.initState();
    Future.delayed(
      const Duration(milliseconds: 100), // Small delay for fade-in
      () {
        if (mounted) {
          setState(() {
            _opacity = 1.0;
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                // This is the crucial fix: music only plays after this click.
                widget.game.audioManager.playMusic(); // <-- THE FIX IS HERE
